...
export const metadata: Metadata = {
  title: "Nova palavra-passe — Equipa Dufat",
  robots: { index: false },
};
 ...
 *
 * Sits outside the guarded /equipa layout on purpose: that layout redirects
 * anyone carrying `mustChangePassword` to this page, so a page inside it would
 * redirect to itself forever.
 */
export default async function ReporPasswordEquipaPage() {
