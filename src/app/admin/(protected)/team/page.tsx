              ...
              <table className="w-full text-sm">
                ...
                <tbody className="table-rows">
                  {members.map((member) => {
                    ...
                    const isLastAdmin =
                      member.role === "ADMIN" && member.active && activeAdmins <= 1;
                    ...
                    return (
                      <MemberRow
                        ...
                        membro={{
                          ...
                          iniciais: initials(member.name),
                          ultimaEntrada: member.lastLoginAt
                            ? formatDate(member.lastLoginAt)
                            : "Nunca entrou",
                          membroDesde: formatDate(member.createdAt),
                          convidadoPor: member.invitedBy?.name ?? null,
                          isSelf,
                          motivoBloqueio: isLastAdmin
                            ? "É o único administrador ativo — as permissões e o acesso ficam fixos até existir outro."
                            : isSelf
                              ? "Não pode alterar as suas próprias permissões nem desativar-se."
                              : undefined,
                        }}
                      />
                    );
